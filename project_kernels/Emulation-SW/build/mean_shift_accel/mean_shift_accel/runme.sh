...
HD_PWD='/home/centos/workspace/project_kernels/Emulation-SW/build/mean_shift_accel/mean_shift_accel'
cd "$HD_PWD"
...
EAStep vitis_hls -f mean_shift_accel.tcl -messageDb vitis_hls.pb
