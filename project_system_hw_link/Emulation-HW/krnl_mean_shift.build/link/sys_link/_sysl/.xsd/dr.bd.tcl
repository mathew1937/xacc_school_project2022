...
#---------------------------
# Instantiating mean_shift_accel_1
#---------------------------
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins -auto_enable /mean_shift_accel_1/s_axi_control] \

connect_bd_net  \
  [get_bd_pins -auto_enable /kernel_clk/clk] \
  [get_bd_pins -auto_enable /slr1/interconnect_axilite_user_1/M01_ACLK] \
  [get_bd_pins -auto_enable /mean_shift_accel_1/ap_clk] \
...
connect_bd_net  \
  ...
  [get_bd_pins -auto_enable /mean_shift_accel_1/ap_rst_n] \
...
sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /mean_shift_accel_1/m_axi_gmem1] \
  [get_bd_cells /memory_subsystem] [list M01_AXI_MEM00]

sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /mean_shift_accel_1/m_axi_gmem2] \
  [get_bd_cells /memory_subsystem] [list M01_AXI_MEM00]

sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /mean_shift_accel_1/m_axi_gmem4] \
  [get_bd_cells /memory_subsystem] [list M01_AXI_MEM00]

sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /mean_shift_accel_1/m_axi_gmem3] \
  [get_bd_cells /memory_subsystem] [list M01_AXI_MEM00]

sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /mean_shift_accel_1/m_axi_gmem5] \
  [get_bd_cells /memory_subsystem] [list M01_AXI_MEM00]
