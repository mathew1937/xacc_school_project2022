...
set kernel_ip_dirs [list \
 "$vpp_link_root/int/xo/ip_repo/xilinx_com_hls_mean_shift_accel_1_0"]
...
set config_info [dict create \
  ...
  no_ip_cache               false \
  remote_ip_cache          "/home/centos/workspace/project_system_hw_link/Emulation-HW/.ipcache" \
  user_board_repo           {} \
  user_bconn                {} \
...
set data_profile_mean_shift_accel_1_M_AXI_GMEM1 [dict create \
  port mean_shift_accel_1/M_AXI_GMEM1 \
  option all \
];
set data_profile_mean_shift_accel_1_M_AXI_GMEM2 [dict create \
  port mean_shift_accel_1/M_AXI_GMEM2 \
  option all \
];
set data_profile_mean_shift_accel_1_M_AXI_GMEM3 [dict create \
  port mean_shift_accel_1/M_AXI_GMEM3 \
  option all \
];
set data_profile_mean_shift_accel_1_M_AXI_GMEM4 [dict create \
  port mean_shift_accel_1/M_AXI_GMEM4 \
  option all \
];
set data_profile_mean_shift_accel_1_M_AXI_GMEM5 [dict create \
  port mean_shift_accel_1/M_AXI_GMEM5 \
  option all \
];
set dict_profile [dict create \
  ...
  FIFO "8192" \
  AIE [list] \
  DATA [list $data_profile_mean_shift_accel_1_M_AXI_GMEM1 $data_profile_mean_shift_accel_1_M_AXI_GMEM2 $data_profile_mean_shift_accel_1_M_AXI_GMEM3 $data_profile_mean_shift_accel_1_M_AXI_GMEM4 $data_profile_mean_shift_accel_1_M_AXI_GMEM5] \
  STALL [list] \
  EXEC [list] \
