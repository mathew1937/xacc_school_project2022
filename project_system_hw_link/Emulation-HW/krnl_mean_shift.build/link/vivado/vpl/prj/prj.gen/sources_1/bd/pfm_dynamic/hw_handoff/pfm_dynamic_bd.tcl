...
proc create_hier_cell_System_DPA { parentCell nameHier } {
  ...
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/mean_shift_accel_1} [get_bd_cells /System_DPA/dpa_mon0]
  ...
  set_property -dict [ list \
   ...
   CONFIG.MONITOR_ID {mean_shift_accel_1:m_axi_gmem1-DDR[1]} \
   CONFIG.TRACE_READ_ID {0} \
   CONFIG.TRACE_WRITE_ID {1} \
 ] $dpa_mon1
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/mean_shift_accel_1/m_axi_gmem1-DDR[1]} [get_bd_cells /System_DPA/dpa_mon1]
  ...
  set_property -dict [ list \
   ...
   CONFIG.EN_AXI_LITE {1} \
   CONFIG.MODE_SDACCEL {true} \
   CONFIG.MONITOR_ID {mean_shift_accel_1:m_axi_gmem2-DDR[1]} \
   CONFIG.TRACE_READ_ID {2} \
   CONFIG.TRACE_WRITE_ID {3} \
 ] $dpa_mon2
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/mean_shift_accel_1/m_axi_gmem2-DDR[1]} [get_bd_cells /System_DPA/dpa_mon2]
  ...
  set_property -dict [ list \
   ...
   CONFIG.EN_AXI_LITE {1} \
   CONFIG.MODE_SDACCEL {true} \
   CONFIG.MONITOR_ID {mean_shift_accel_1:m_axi_gmem3-DDR[1]} \
   CONFIG.TRACE_READ_ID {4} \
   CONFIG.TRACE_WRITE_ID {5} \
 ] $dpa_mon3
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/mean_shift_accel_1/m_axi_gmem3-DDR[1]} [get_bd_cells /System_DPA/dpa_mon3]
  ...
  set_property -dict [ list \
   ...
   CONFIG.EN_AXI_LITE {1} \
   CONFIG.MODE_SDACCEL {true} \
   CONFIG.MONITOR_ID {mean_shift_accel_1:m_axi_gmem4-DDR[1]} \
   CONFIG.TRACE_READ_ID {6} \
   CONFIG.TRACE_WRITE_ID {7} \
 ] $dpa_mon4
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/mean_shift_accel_1/m_axi_gmem4-DDR[1]} [get_bd_cells /System_DPA/dpa_mon4]
  ...
  set_property -dict [ list \
   ...
   CONFIG.EN_AXI_LITE {1} \
   CONFIG.MODE_SDACCEL {true} \
   CONFIG.MONITOR_ID {mean_shift_accel_1:m_axi_gmem5-DDR[1]} \
   CONFIG.TRACE_READ_ID {8} \
   CONFIG.TRACE_WRITE_ID {9} \
 ] $dpa_mon5
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/mean_shift_accel_1/m_axi_gmem5-DDR[1]} [get_bd_cells /System_DPA/dpa_mon5]
  ...
  connect_bd_intf_net -intf_net mean_shift_accel_1_m_axi_gmem1 [get_bd_intf_pins MON_M_AXI] [get_bd_intf_pins dpa_mon1/MON_M_AXI]
  connect_bd_intf_net -intf_net mean_shift_accel_1_m_axi_gmem2 [get_bd_intf_pins MON_M_AXI1] [get_bd_intf_pins dpa_mon2/MON_M_AXI]
  connect_bd_intf_net -intf_net mean_shift_accel_1_m_axi_gmem3 [get_bd_intf_pins MON_M_AXI2] [get_bd_intf_pins dpa_mon3/MON_M_AXI]
  connect_bd_intf_net -intf_net mean_shift_accel_1_m_axi_gmem4 [get_bd_intf_pins MON_M_AXI3] [get_bd_intf_pins dpa_mon4/MON_M_AXI]
  connect_bd_intf_net -intf_net mean_shift_accel_1_m_axi_gmem5 [get_bd_intf_pins MON_M_AXI4] [get_bd_intf_pins dpa_mon5/MON_M_AXI]
  connect_bd_intf_net -intf_net slr1_M01_AXI [get_bd_intf_pins MON_S_AXI] [get_bd_intf_pins dpa_mon1/MON_S_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets slr1_M01_AXI] [get_bd_intf_pins MON_S_AXI] [get_bd_intf_pins dpa_mon2/MON_S_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets slr1_M01_AXI] [get_bd_intf_pins MON_S_AXI] [get_bd_intf_pins dpa_mon3/MON_S_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets slr1_M01_AXI] [get_bd_intf_pins MON_S_AXI] [get_bd_intf_pins dpa_mon4/MON_S_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets slr1_M01_AXI] [get_bd_intf_pins MON_S_AXI] [get_bd_intf_pins dpa_mon5/MON_S_AXI]
  ...
  connect_bd_net -net slr1_peripheral_aresetn [get_bd_pins trace_rst] [get_bd_pins dpa_ctrl_interconnect/M00_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M01_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M02_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M03_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M04_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M05_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M06_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M07_ARESETN] [get_bd_pins dpa_hub/axilite_aresetn] [get_bd_pins dpa_hub/trace_aresetn] [get_bd_pins dpa_mon0/mon_resetn] [get_bd_pins dpa_mon0/trace_rst] [get_bd_pins dpa_mon1/mon_resetn] [get_bd_pins dpa_mon1/trace_rst] [get_bd_pins dpa_mon2/mon_resetn] [get_bd_pins dpa_mon2/trace_rst] [get_bd_pins dpa_mon3/mon_resetn] [get_bd_pins dpa_mon3/trace_rst] [get_bd_pins dpa_mon4/mon_resetn] [get_bd_pins dpa_mon4/trace_rst] [get_bd_pins dpa_mon5/mon_resetn] [get_bd_pins dpa_mon5/trace_rst]
...
proc create_root_design { parentCell } {
  ...
  set_property APERTURES {{0x1C00_0000 64M}} [get_bd_intf_ports userpf_control_M_AXI]
  ...
  # Create instance: mean_shift_accel_1, and set properties
  set mean_shift_accel_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mean_shift_accel:1.0 mean_shift_accel_1 ]
  set_property HDL_ATTRIBUTE.DPA_MONITOR {true} [get_bd_cells mean_shift_accel_1]
  set_property HDL_ATTRIBUTE.DPA_MONITOR {true} [get_bd_intf_pins /mean_shift_accel_1/m_axi_gmem1]
  set_property HDL_ATTRIBUTE.DPA_MONITOR {true} [get_bd_intf_pins /mean_shift_accel_1/m_axi_gmem2]
  set_property HDL_ATTRIBUTE.DPA_MONITOR {true} [get_bd_intf_pins /mean_shift_accel_1/m_axi_gmem3]
  set_property HDL_ATTRIBUTE.DPA_MONITOR {true} [get_bd_intf_pins /mean_shift_accel_1/m_axi_gmem4]
  set_property HDL_ATTRIBUTE.DPA_MONITOR {true} [get_bd_intf_pins /mean_shift_accel_1/m_axi_gmem5]
  ...
  set_property -dict [ list \
   CONFIG.ADVANCED_PROPERTIES {resource_map_replication {S00_AXI {} S01_AXI {} S02_AXI {} S03_AXI {}}\
plram_specifications {{ SIZE 128K AXI_DATA_WIDTH 512 SLR_ASSIGNMENT SLR2 } {\
SIZE 128K AXI_DATA_WIDTH 512 SLR_ASSIGNMENT SLR1 } { SIZE 128K AXI_DATA_WIDTH\
512 SLR_ASSIGNMENT SLR0 }} resource_access_constraints {S00_AXI {M00_AXI_MEM00\
PLRAM_MEM00 PLRAM_MEM01 PLRAM_MEM02} S01_AXI M01_AXI_MEM00 S02_AXI\
M02_AXI_MEM00 S03_AXI M03_AXI_MEM00} __temp_dsa_info {excluded_board_components\
{amazon:minotaur-vu9p-f1:ddr4_sdram_c0:1.0\
amazon:minotaur-vu9p-f1:ddr4_sdram_c1:1.0\
amazon:minotaur-vu9p-f1:ddr4_sdram_c2:1.0\
amazon:minotaur-vu9p-f1:ddr4_sdram_c3:1.0} axi_passthrough\
{amazon:minotaur-vu9p-f1:ddr4_sdram_c0:1.0 {offset 0x4000000000 range 16G slr\
SLR0} amazon:minotaur-vu9p-f1:ddr4_sdram_c1:1.0 {offset 0x400000000 range 16G\
slr SLR1} amazon:minotaur-vu9p-f1:ddr4_sdram_c2:1.0 {offset 0x4800000000 range\
16G slr SLR1} amazon:minotaur-vu9p-f1:ddr4_sdram_c3:1.0 {offset 0x4c00000000\
range 16G slr SLR2}} sim_props {ddr4_0 {offset 0x4000000000 range 0x400000000\
slr SLR0 passthrough yes} ddr4_1 {offset 0x400000000 range 0x400000000 slr SLR1\
passthrough yes} ddr4_2 {offset 0x4800000000 range 0x400000000 slr SLR1\
passthrough yes} ddr4_3 {offset 0x4c00000000 range 0x400000000 slr SLR2\
passthrough yes} plram_0 {offset 0x5000000000 range 0x20000 slr SLR0\
passthrough no} plram_1 {offset 0x5000020000 range 0x20000 slr SLR1 passthrough\
no} plram_2 {offset 0x5000040000 range 0x20000 slr SLR2 passthrough no}}\
slr_pblock_map {SLR0 block_dynamic_SLR0 SLR1 pblock_dynamic_SLR1 SLR2\
pblock_dynamic_SLR2} child_pblock_declarations {pblock_ddr4_mem00 {range\
CLOCKREGION_X2Y1:CLOCKREGION_X2Y3 parent pblock_dynamic_SLR0 cell_paths\
memory/ddr4_mem00} pblock_ddr4_mem02 {range CLOCKREGION_X2Y7:CLOCKREGION_X2Y9\
parent pblock_dynamic_SLR1 cell_paths memory/ddr4_mem02} pblock_ddr4_mem03\
{range CLOCKREGION_X4Y11:CLOCKREGION_X4Y13 parent pblock_dynamic_SLR2\
cell_paths memory/ddr4_mem03}} board_component_slr_map {aws_ddra SLR2 aws_ddrb\
SLR1 aws_ddrc SLR1 aws_ddrd SLR0}}}\
   CONFIG.NUM_CLKS {2} \
   CONFIG.NUM_SI {9} \
 ] $memory_subsystem

  set_property SELECTED_SIM_MODEL tlm  $memory_subsystem
  ...
  connect_bd_intf_net -intf_net mean_shift_accel_1_m_axi_gmem1 [get_bd_intf_pins mean_shift_accel_1/m_axi_gmem1] [get_bd_intf_pins memory_subsystem/S04_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets mean_shift_accel_1_m_axi_gmem1] [get_bd_intf_pins System_DPA/MON_M_AXI] [get_bd_intf_pins memory_subsystem/S04_AXI]
  connect_bd_intf_net -intf_net mean_shift_accel_1_m_axi_gmem2 [get_bd_intf_pins mean_shift_accel_1/m_axi_gmem2] [get_bd_intf_pins memory_subsystem/S05_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets mean_shift_accel_1_m_axi_gmem2] [get_bd_intf_pins System_DPA/MON_M_AXI1] [get_bd_intf_pins memory_subsystem/S05_AXI]
  connect_bd_intf_net -intf_net mean_shift_accel_1_m_axi_gmem3 [get_bd_intf_pins mean_shift_accel_1/m_axi_gmem3] [get_bd_intf_pins memory_subsystem/S07_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets mean_shift_accel_1_m_axi_gmem3] [get_bd_intf_pins System_DPA/MON_M_AXI2] [get_bd_intf_pins memory_subsystem/S07_AXI]
  connect_bd_intf_net -intf_net mean_shift_accel_1_m_axi_gmem4 [get_bd_intf_pins mean_shift_accel_1/m_axi_gmem4] [get_bd_intf_pins memory_subsystem/S06_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets mean_shift_accel_1_m_axi_gmem4] [get_bd_intf_pins System_DPA/MON_M_AXI3] [get_bd_intf_pins memory_subsystem/S06_AXI]
  connect_bd_intf_net -intf_net mean_shift_accel_1_m_axi_gmem5 [get_bd_intf_pins mean_shift_accel_1/m_axi_gmem5] [get_bd_intf_pins memory_subsystem/S08_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets mean_shift_accel_1_m_axi_gmem5] [get_bd_intf_pins System_DPA/MON_M_AXI4] [get_bd_intf_pins memory_subsystem/S08_AXI]
  ...
  connect_bd_intf_net -intf_net slr1_M01_AXI [get_bd_intf_pins mean_shift_accel_1/s_axi_control] [get_bd_intf_pins slr1/M01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets slr1_M01_AXI] [get_bd_intf_pins System_DPA/MON_S_AXI] [get_bd_intf_pins slr1/M01_AXI]
  ...
  connect_bd_net -net mean_shift_accel_1_interrupt [get_bd_pins interrupt_concat/In0] [get_bd_pins mean_shift_accel_1/interrupt]
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins System_DPA/trace_clk] [get_bd_pins kernel_clk/clk] [get_bd_pins mean_shift_accel_1/ap_clk] [get_bd_pins memory_subsystem/aclk1] [get_bd_pins slr0/slowest_sync_clk] [get_bd_pins slr1/slowest_sync_clk] [get_bd_pins slr2/slowest_sync_clk]
  ...
  connect_bd_net -net slr1_peripheral_aresetn [get_bd_pins System_DPA/trace_rst] [get_bd_pins mean_shift_accel_1/ap_rst_n] [get_bd_pins slr1/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x000400000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S04_AXI/M01_AXI_MEM00] -force
  assign_bd_address -offset 0x000400000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem2] [get_bd_addr_segs memory_subsystem/S05_AXI/M01_AXI_MEM00] -force
  assign_bd_address -offset 0x000400000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem4] [get_bd_addr_segs memory_subsystem/S06_AXI/M01_AXI_MEM00] -force
  assign_bd_address -offset 0x000400000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem3] [get_bd_addr_segs memory_subsystem/S07_AXI/M01_AXI_MEM00] -force
  assign_bd_address -offset 0x000400000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem5] [get_bd_addr_segs memory_subsystem/S08_AXI/M01_AXI_MEM00] -force
  assign_bd_address -offset 0x000400000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces memory_subsystem/M01_AXI] [get_bd_addr_segs C0_DDR_MAXI_0/Reg] -force
  ...
  assign_bd_address -offset 0x1D060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs System_DPA/dpa_mon4/S_AXI/Reg] -force
  assign_bd_address -offset 0x1D070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs System_DPA/dpa_mon5/S_AXI/Reg] -force
  assign_bd_address -offset 0x1D080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs mean_shift_accel_1/s_axi_control/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S04_AXI/M00_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004800000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S04_AXI/M02_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004C00000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S04_AXI/M03_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x005000020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x005000040000 -range 0x00020000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM02]
  exclude_bd_addr_seg -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem2] [get_bd_addr_segs memory_subsystem/S05_AXI/M00_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004800000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem2] [get_bd_addr_segs memory_subsystem/S05_AXI/M02_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004C00000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem2] [get_bd_addr_segs memory_subsystem/S05_AXI/M03_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem2] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x005000020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem2] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x005000040000 -range 0x00020000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem2] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM02]
  exclude_bd_addr_seg -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem3] [get_bd_addr_segs memory_subsystem/S07_AXI/M00_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004800000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem3] [get_bd_addr_segs memory_subsystem/S07_AXI/M02_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004C00000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem3] [get_bd_addr_segs memory_subsystem/S07_AXI/M03_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem3] [get_bd_addr_segs memory_subsystem/S07_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x005000020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem3] [get_bd_addr_segs memory_subsystem/S07_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x005000040000 -range 0x00020000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem3] [get_bd_addr_segs memory_subsystem/S07_AXI/PLRAM_MEM02]
  exclude_bd_addr_seg -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem4] [get_bd_addr_segs memory_subsystem/S06_AXI/M00_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004800000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem4] [get_bd_addr_segs memory_subsystem/S06_AXI/M02_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004C00000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem4] [get_bd_addr_segs memory_subsystem/S06_AXI/M03_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem4] [get_bd_addr_segs memory_subsystem/S06_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x005000020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem4] [get_bd_addr_segs memory_subsystem/S06_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x005000040000 -range 0x00020000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem4] [get_bd_addr_segs memory_subsystem/S06_AXI/PLRAM_MEM02]
  exclude_bd_addr_seg -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem5] [get_bd_addr_segs memory_subsystem/S08_AXI/M00_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004800000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem5] [get_bd_addr_segs memory_subsystem/S08_AXI/M02_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004C00000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem5] [get_bd_addr_segs memory_subsystem/S08_AXI/M03_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem5] [get_bd_addr_segs memory_subsystem/S08_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x005000020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem5] [get_bd_addr_segs memory_subsystem/S08_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x005000040000 -range 0x00020000 -target_address_space [get_bd_addr_spaces mean_shift_accel_1/Data_m_axi_gmem5] [get_bd_addr_segs memory_subsystem/S08_AXI/PLRAM_MEM02]
