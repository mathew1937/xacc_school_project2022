namespace eval ::optrace {
  variable script "/home/centos/workspace/project_system_hw_link/Emulation-HW/krnl_mean_shift.build/link/vivado/vpl/vpl.tcl"
...
OPTRACE "Open BD and capture sim_ipc aximm addressing details" END { }
  ...
  ocl_util::add_to_steps_log $steps_log "internal step: import_files /home/centos/workspace/project_system_hw_link/Emulation-HW/krnl_mean_shift.build/link/vivado/vpl/.local/hw_platform/emu/emu/emu.bd" [ocl_util::extFileName]:[expr {[dict get [info frame -1] line] + [dict get [info frame 0] line]}]
  import_files -force /home/centos/workspace/project_system_hw_link/Emulation-HW/krnl_mean_shift.build/link/vivado/vpl/.local/hw_platform/emu/emu/emu.bd
